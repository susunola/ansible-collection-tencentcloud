...
| `dcdb_account` | Manage Tencent Cloud DCDB accounts |
...
| `dlc_cluster_group` | Manage Tencent Cloud DLC compute cluster groups |
| `dlc_data_engine` | Manage Tencent Cloud Data Lake Compute engines |
| `dlc_data_engine_config` | Reconcile Tencent Cloud DLC data-engine runtime configuration |
...
| `oceanus_meta_table` | Manage Tencent Cloud Oceanus metadata tables |
...
| `tcb_auth_domain` | Manage Tencent CloudBase authentication domains |
...
| `tdcpg_account` | Govern a TDSQL-C PostgreSQL account |
| `tdcpg_cluster` | Manage Tencent Cloud TDSQL-C PostgreSQL clusters |
| `tdcpg_endpoint_wan` | Manage public access for a TDSQL-C PostgreSQL endpoint |
| `tdcpg_instance_state` | Manage TDSQL-C PostgreSQL instance runtime state |
...
| `tione_model_service_auth_token` | Manage Tencent Cloud TIONE model service authentication tokens |
...
| `tse_config_file_deployment` | Atomically deploy a Tencent Cloud TSE configuration file and release |
...
| `tse_gateway_model_api` | Manage a Tencent Cloud TSE AI gateway model API |
| `tse_gateway_model_api_group_auth` | Manage TSE gateway Model API consumer group authorization |
| `tse_gateway_model_service` | Manage a Tencent Cloud TSE AI gateway model service |
...
| `tse_gateway_upstream_node_status` | Reconcile Tencent Cloud TSE gateway upstream node health state |
...
| `tse_governance_host_retirement` | Retire all Tencent Cloud TSE governance instances on a host |
| `tse_governance_instance` | Manage a Tencent Cloud TSE governance service instance |
| `tse_governance_lane_group` | Manage a Tencent Cloud TSE governance lane group |
...
<details>
<summary><strong>Browse all 329 read-only <code>_info</code> modules</strong></summary>
...
| `tione_training_task_info` | Gather Tencent Cloud TIONE training tasks |
...
| `tse_config_file_catalog_info` | Gather Tencent Cloud TSE configuration file inventory |

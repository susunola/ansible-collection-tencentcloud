...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dlc_resource_config
    description: Manage Tencent Cloud DLC Ray and Spark resource templates.
...
RETURN = r'''
resource_configs:
  description: Matching DLC resource configs.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.ListResourceConfigs, request),

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dlc_user
    description: Manage Tencent Cloud Data Lake Compute users.
...
RETURN = r'''
users:
  description: Matching DLC users.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeUsers, request),
        lambda response: response.UserSet,

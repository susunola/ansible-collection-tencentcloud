...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tdmq_topic
    description: Manage Tencent Cloud TDMQ Pulsar topics.
...
RETURN = r'''
topics:
  description: Matching TDMQ topics.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda response: response.TopicSets,

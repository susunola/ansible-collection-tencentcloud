...
options:
  filters:
    description: ECDN API filter names mapped to lists of values.
    type: dict
    default: {}
  page_size:
...
RETURN = r'''
domains:
  description: Matching ECDN domains.
  returned: always
  type: list
  elements: dict
total_count:
...
def build_request(models, filters, offset, limit):
    ...
    if filters:
        ...
        for name, values in sorted(filters.items()):
            api_filter = models.DomainFilter()
...
def run_module():
    ...
    try:
        from tencentcloud.ecdn.v20191012 import models, ecdn_client
    except ImportError:
        module.fail_json(msg="The tencentcloud-sdk-python-ecdn package is required.")

    client = ecdn_client.EcdnClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "ecdn.tencentcloudapi.com"),
    )
    paginator = Paginator(

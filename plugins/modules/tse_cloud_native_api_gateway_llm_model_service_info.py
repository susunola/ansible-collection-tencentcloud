...
RETURN = r'''
cloud_native_api_gateway_llm_model_services:
  description: Matching TSE cloud native api gateway llm model services.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeCloudNativeAPIGatewayLLMModelServices, request),
    ...
    cloud_native_api_gateway_llm_model_services = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, cloud_native_api_gateway_llm_model_services=cloud_native_api_gateway_llm_model_services,

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tke_node_pool_info
    description: Gather information about Tencent Cloud TKE node pools.
...
def run_module():
    ...
    try:
        ...
        fail_from_sdk_error(module, exc, "DescribeClusterNodePools")

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tse_sre_instance
    description: Manage Tencent Cloud TSE service registry engines.
...
def run_module():
    ...
    module.exit_json(changed=False, sre_instances=sre_instances,

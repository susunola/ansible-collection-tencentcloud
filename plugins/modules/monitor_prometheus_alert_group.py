...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.monitor_prometheus_alert_group_info
    description: Gather information about Tencent Cloud Monitor Prometheus alert groups.
...
RETURN = r"""alert_group:
  description:
    - Prometheus alert-group metadata.
  returned: always
  type: dict"""

...
RETURN = r'''
private_zones:
  description: Matching PRIVATEDNS private zones.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribePrivateZoneList, request),
        lambda response: response.PrivateZoneSet,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    private_zones = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, private_zones=private_zones,

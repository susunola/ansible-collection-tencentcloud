...
RETURN = r'''
account_factory_baseline_items:
  description: Matching CONTROLCENTER account factory baseline items.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        from tencentcloud.controlcenter.v20230110 import models, controlcenter_client
    except ImportError:
        module.fail_json(msg="The tencentcloud-sdk-python-controlcenter package is required.")

    client = controlcenter_client.ControlcenterClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "controlcenter.tencentcloudapi.com"),
    )
    paginator = Paginator(
        module.params["page_size"],
        lambda offset, limit: build_request(models, offset, limit),
        lambda request: sdk_call(module, client.ListAccountFactoryBaselineItems, request),
        lambda response: response.BaselineItems,

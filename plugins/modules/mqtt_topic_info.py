...
options:
  instance_id:
    description: Sets the C(InstanceId) field of V(DescribeTopicList); omit it to leave that field unset.
    type: str
  filters:
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.mqtt_topic
    description: Manage Tencent Cloud MQTT topics.
...
RETURN = r'''
topics:
  description: Matching MQTT topics.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda offset, limit: build_request(
            ...
            offset,
            limit),
        lambda request: sdk_call(module, client.DescribeTopicList, request),

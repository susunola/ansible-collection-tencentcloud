...
options:
  instance_id:
    description: Sets the C(InstanceId) field of V(DescribeUserBindWorkloadGroup); omit it to leave that field unset.
    type: str
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cdwdoris_user_workload_group
    description: Bind a Tencent Cloud CDW Doris user to a workload group.

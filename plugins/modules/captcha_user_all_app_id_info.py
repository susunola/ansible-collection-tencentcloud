...
RETURN = r'''
user_all_app_ids:
  description: Matching CAPTCHA user all app ids.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    user_all_app_ids = [serialize_sdk_object(item) for item in items]
    module.exit_json(changed=False, user_all_app_ids=user_all_app_ids,
                     total_count=len(user_all_app_ids), request_id=response.RequestId)

...
RETURN = r'''
address_template_groups:
  description: Matching address template groups.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeAddressTemplateGroups, request),
        lambda response: response.AddressTemplateGroupSet,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    address_template_groups = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, address_template_groups=address_template_groups,

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cls_alarm
    description: Create or delete a Tencent Cloud CLS alarm.
...
RETURN = r'''
alarms:
  description: Matching CLS alarms.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeAlarms, request),
        lambda response: response.Alarms,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    alarms = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, alarms=alarms,

...
RETURN = r'''
rabbit_mq_vip_instances:
  description: Matching TDMQ rabbit mq vip instances.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeRabbitMQVipInstances, request),
        lambda response: response.Instances,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    rabbit_mq_vip_instances = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, rabbit_mq_vip_instances=rabbit_mq_vip_instances,

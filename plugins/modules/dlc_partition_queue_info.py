...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dlc_partition_queue
    description: Manage Tencent Cloud DLC resource partition queues.
...
RETURN = r'''
partition_queues:
  description: Matching DLC partition queues.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribePartitionQueues, request),
        lambda response: response.QueueList,
        lambda response: response.Total,
    )
    item_set, total_count = paginator.fetch_all()
    partition_queues = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, partition_queues=partition_queues,

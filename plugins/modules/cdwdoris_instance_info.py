...
options:
  ...
  search_instance_name:
    ...
    type: str
  instance_type:
    description: Sets the C(InstanceType) field of V(DescribeInstances); omit it to leave that field unset.
    type: int
  page_size:
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cdwdoris_instance
    description: Manage Tencent Cloud CDW Doris instances.
...
RETURN = r'''
instances:
  description: Matching CDWDORIS instances.
  returned: always
  type: list
  elements: dict
total_count:
...
def build_request(models, search_instance_id, search_instance_name, instance_type, offset, limit):
    request = models.DescribeInstancesRequest()
    request.Offset = offset
    request.Limit = limit
    if search_instance_id is not None:
        request.SearchInstanceId = search_instance_id
    if search_instance_name is not None:
        request.SearchInstanceName = search_instance_name
...
def run_module():
    ...
    argument_spec.update({
        "search_instance_id": {"type": "str"},
        "search_instance_name": {"type": "str"},
    ...
    paginator = Paginator(
        ...
        lambda offset, limit: build_request(
            models,
            module.params["search_instance_id"],
            module.params["search_instance_name"],

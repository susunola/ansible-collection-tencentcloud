...
options:
  ...
  gateway_id:
    description:
      - Gateway the autoscaling strategy is defined on.
    type: str
    required: true
  strategy_id:
    description:
  ...
  metric_config:
    description:
      - SDK CloudNativeAPIGatewayStrategyAutoScalerConfig payload.
    type: dict
  cron_config:
    description:
      - SDK CloudNativeAPIGatewayStrategyCronScalerConfig payload.
    type: dict
  max_replicas:
    description:

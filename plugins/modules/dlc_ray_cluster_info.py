...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dlc_ray_cluster
    description: Manage Tencent Cloud DLC Ray clusters.
...
RETURN = r'''
ray_clusters:
  description: Matching DLC ray clusters.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.ListRayClusters, request),
        lambda response: response.Items,
        lambda response: response.Total,
    )
    item_set, total_count = paginator.fetch_all()
    ray_clusters = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, ray_clusters=ray_clusters,

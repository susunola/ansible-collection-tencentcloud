...
options:
  filters:
    description: CTSDB API filter names mapped to lists of values.
    type: dict
    default: {}
  page_size:
...
RETURN = r'''
clusters:
  description: Matching CTSDB clusters.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        from tencentcloud.ctsdb.v20230202 import models, ctsdb_client
    except ImportError:
        module.fail_json(msg="The tencentcloud-sdk-python-ctsdb package is required.")

    client = ctsdb_client.CtsdbClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "ctsdb.tencentcloudapi.com"),
    )
    paginator = Paginator(

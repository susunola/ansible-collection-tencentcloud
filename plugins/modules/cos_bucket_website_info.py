...
DOCUMENTATION = r'''
---
module: cos_bucket_website_info
short_description: Gather Tencent Cloud COS static website configuration
version_added: "1.4.0"
description: Returns the effective static website configuration of a COS bucket.
options:
  name:
    description:
...
'''
EXAMPLES = r'''
- susunola.tencentcloud.cos_bucket_website_info:
    region: ap-guangzhou
    name: public-site
'''
RETURN = r'''
...
def run_module():
    ...
    try:
        website = read_website(cos.create_cos_client(module), bucket)
        module.exit_json(changed=False, websites=[website] if website else [], website=website)
    except Exception as exc:

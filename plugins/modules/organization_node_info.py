...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.organization_node
    description: Manage Tencent Cloud Organization nodes.
...
RETURN = r'''
nodes:
  description: Matching ORGANIZATION nodes.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeOrganizationNodes, request),
        lambda response: response.Items,
        lambda response: response.Total,
    )
    item_set, total_count = paginator.fetch_all()
    nodes = [serialize_sdk_object(item) for item in item_set]

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tse_governance_service
    description: Manage a Tencent Cloud TSE governance service.
...
RETURN = r'''
governance_services:
  description: Matching TSE governance services.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeGovernanceServices, request),
        lambda response: response.Content,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    governance_services = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, governance_services=governance_services,

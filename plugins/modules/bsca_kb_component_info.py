...
RETURN = r'''
kb_components:
  description: Matching BSCA kb components.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        from tencentcloud.bsca.v20210811 import models, bsca_client
    except ImportError:
        module.fail_json(msg="The tencentcloud-sdk-python-bsca package is required.")

    client = bsca_client.BscaClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "bsca.tencentcloudapi.com"),
    )
    paginator = Paginator(
    ...
    kb_components = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, kb_components=kb_components, total_count=total_count)

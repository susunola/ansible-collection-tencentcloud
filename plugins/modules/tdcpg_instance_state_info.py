...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tdcpg_instance_state
    description: Manage TDSQL-C PostgreSQL instance runtime state.
...
def build_request(models, cluster_id, order_by, order_by_type, filters, offset, limit):
    ...
    if order_by_type is not None:
        request.OrderByType = order_by_type
    if filters:
        request.Filters = []
...
def run_module():
    ...
    module.exit_json(changed=False, cluster_instances=cluster_instances,

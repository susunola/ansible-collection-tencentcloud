...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dlc_lab
    description: Manage Tencent Cloud DLC data laboratories.
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.ListLabs, request),
        lambda response: response.Items,
        lambda response: response.Total,
    )
    item_set, total_count = paginator.fetch_all()
    labs = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, labs=labs,

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dlc_table
    description: Manage Tencent Cloud DLC metadata tables.
...
RETURN = r'''
tables:
  description: Matching DLC tables.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeTables, request),
        lambda response: response.TableList,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    tables = [serialize_sdk_object(item) for item in item_set]

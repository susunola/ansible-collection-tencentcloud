...
options:
  instance_id:
    description: ID of the MariaDB instance whose backup configuration is returned.
    type: str
    required: true
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.mariadb_backup_config
    description: Manage TencentDB for MariaDB automatic backup configuration.
...
def build_request(models, instance_id, offset, limit):
    # DescribeBackupConfigs takes no request arguments and is not
...
def run_module():
    ...
    response = sdk_call(module, client.DescribeBackupConfigs, request)

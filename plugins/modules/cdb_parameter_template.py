...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cdb_parameter_template_info
    description: Gather information about Tencent Cloud CDB parameter templates.
...
RETURN = r"""parameter_template:
  description:
    - CDB parameter template metadata.
  returned: always
  type: dict"""

...
options:
  filters:
    description: CHC API filter names mapped to lists of values.
    type: dict
    default: {}
  page_size:
...
RETURN = r'''
devices:
  description: Matching CHC devices.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        from tencentcloud.chc.v20230418 import models, chc_client
    except ImportError:
        module.fail_json(msg="The tencentcloud-sdk-python-chc package is required.")

    client = chc_client.ChcClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "chc.tencentcloudapi.com"),
    )
    paginator = Paginator(

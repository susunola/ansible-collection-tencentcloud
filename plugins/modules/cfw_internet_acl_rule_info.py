...
options:
  index:
    description: Sets the C(Index) field of V(DescribeAclRule); omit it to leave that field unset.
    type: str
  start_time:
    description: Sets the C(StartTime) field of V(DescribeAclRule); omit it to leave that field unset.
    type: str
  end_time:
    description: Sets the C(EndTime) field of V(DescribeAclRule); omit it to leave that field unset.
    type: str
  order:
    description: Sets the C(Order) field of V(DescribeAclRule); omit it to leave that field unset.
    type: str
  by:
    description: Sets the C(By) field of V(DescribeAclRule); omit it to leave that field unset.
    type: str
  filters:
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cfw_internet_acl_rule
    description: Manage Tencent Cloud Cloud Firewall internet border ACL rules.
...
RETURN = r'''
acl_rules:
  description: Matching CFW acl rules.
  returned: always
  type: list
  elements: dict
total_count:

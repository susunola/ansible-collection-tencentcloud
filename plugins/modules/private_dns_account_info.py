...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.private_dns_account
    description: Manage Tencent Cloud Private DNS cross-account authorization.
...
RETURN = r'''
private_dns_accounts:
  description: Matching PRIVATEDNS private dns accounts.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribePrivateDNSAccountList, request),
        lambda response: response.AccountSet,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    private_dns_accounts = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, private_dns_accounts=private_dns_accounts,

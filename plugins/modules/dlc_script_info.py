...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dlc_script
    description: Manage Tencent Cloud DLC saved SQL scripts.
...
RETURN = r'''
scripts:
  description: Matching DLC scripts.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeScripts, request),
        lambda response: response.Scripts,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    scripts = [serialize_sdk_object(item) for item in item_set]

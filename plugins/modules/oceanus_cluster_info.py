...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.oceanus_cluster
    description: Manage Tencent Cloud Oceanus dedicated clusters.

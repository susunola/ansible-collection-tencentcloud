...
options:
  filters:
    description: CDN API domain filter names mapped to lists of values.
    type: dict
    default: {}
  page_size:
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cdn_domain
    description: Manage Tencent Cloud CDN domains.
...
RETURN = r'''
domains:
  description: Matching CDN domains.
  returned: always
  type: list
  elements: dict
total_count:

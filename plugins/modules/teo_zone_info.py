...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.teo_zone
    description: Manage Tencent Cloud EdgeOne zones.
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeZones, request),
        lambda response: response.Zones,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    zones = [serialize_sdk_object(item) for item in item_set]

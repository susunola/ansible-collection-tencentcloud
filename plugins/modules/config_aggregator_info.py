...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.config_aggregator
    description: Manage creation of Tencent Cloud Config account aggregators.
...
RETURN = r'''
aggregators:
  description: Matching aggregators.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.ListAggregators, request),
        lambda response: response.Items,
        lambda response: response.Total,
    )
    item_set, total_count = paginator.fetch_all()
    aggregators = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, aggregators=aggregators,

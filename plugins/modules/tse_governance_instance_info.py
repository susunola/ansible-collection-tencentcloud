...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tse_governance_instance
    description: Manage a Tencent Cloud TSE governance service instance.
...
governance_instances:
  description: Matching TSE governance instances.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeGovernanceInstances, request),
        lambda response: response.Content,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    governance_instances = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, governance_instances=governance_instances,

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dlc_cluster_group
    description: Manage Tencent Cloud DLC compute cluster groups.
...
RETURN = r'''
cluster_groups:
  description: Matching DLC cluster groups.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.ListClusterGroups, request),
        lambda response: response.Items,
        lambda response: response.Total,
    )
    item_set, total_count = paginator.fetch_all()
    cluster_groups = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, cluster_groups=cluster_groups,

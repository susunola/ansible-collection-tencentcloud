...
options:
  workspace_id:
    description: Oceanus workspace ID whose jobs are returned.
    type: str
    required: true
  page_size:
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.oceanus_job
    description: Manage Tencent Cloud Oceanus jobs.
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeJobs, request),
        lambda response: response.JobSet,

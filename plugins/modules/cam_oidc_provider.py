...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cam_oidc_provider_info
    description: Gather information about a Tencent Cloud CAM OIDC identity provider.

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.config_compliance_pack
    description: Manage Tencent Cloud Config compliance packs.
...
RETURN = r'''
compliance_packs:
  description: Matching compliance packs.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.ListCompliancePacks, request),
        lambda response: response.Items,
        lambda response: response.Total,
    )
    item_set, total_count = paginator.fetch_all()
    compliance_packs = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, compliance_packs=compliance_packs,

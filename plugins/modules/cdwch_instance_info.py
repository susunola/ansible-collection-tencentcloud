...
def build_request(models, search_instance_id, search_instance_name, instance_type, components, offset, limit):
...
def run_module():
    ...
    module.exit_json(changed=False, cn_instances=cn_instances,

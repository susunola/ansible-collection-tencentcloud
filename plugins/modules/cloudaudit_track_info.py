...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cloudaudit_track
    description: Manage Tencent Cloud CloudAudit tracks.
...
RETURN = r'''
audit_tracks:
  description: Matching CLOUDAUDIT audit tracks.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeAuditTracks, request),
        lambda response: response.Tracks,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    audit_tracks = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, audit_tracks=audit_tracks,

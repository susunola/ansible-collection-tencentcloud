...
options:
  instance_id:
    description: ID of the MongoDB instance whose backup rules are returned.
    type: str
    required: true
...
def build_request(models, instance_id, offset, limit):
    # DescribeBackupRules takes no request arguments and is not
...
def run_module():
    ...
    response = sdk_call(module, client.DescribeBackupRules, request)

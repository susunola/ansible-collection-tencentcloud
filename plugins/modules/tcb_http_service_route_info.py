...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tcb_http_service_route
    description: Manage Tencent CloudBase HTTP service domain routes.
...
RETURN = r'''
http_service_routes:
  description: Matching TCB http service routes.
  returned: always
  type: list
  elements: dict
total_count:
...
def build_request(models, env_id, filters, offset, limit):
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda offset, limit: build_request(
            ...
            offset,
            limit),
        lambda request: sdk_call(module, client.DescribeHTTPServiceRoute, request),
        lambda response: response.Domains,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    http_service_routes = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, http_service_routes=http_service_routes,

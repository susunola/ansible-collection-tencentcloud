...
options:
  index:
    description: Sets the C(Index) field of V(DescribeVpcAcRule); omit it to leave that field unset.
    type: str
  start_time:
    description: Sets the C(StartTime) field of V(DescribeVpcAcRule); omit it to leave that field unset.
    type: str
  end_time:
    description: Sets the C(EndTime) field of V(DescribeVpcAcRule); omit it to leave that field unset.
    type: str
  order:
    description: Sets the C(Order) field of V(DescribeVpcAcRule); omit it to leave that field unset.
    type: str
  by:
    description: Sets the C(By) field of V(DescribeVpcAcRule); omit it to leave that field unset.
    type: str
  filters:
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cfw_vpc_acl_rule
    description: Manage Tencent Cloud Cloud Firewall inter-VPC ACL rules.
...
RETURN = r'''
vpc_ac_rules:
  description: Matching CFW vpc ac rules.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    vpc_ac_rules = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, vpc_ac_rules=vpc_ac_rules,

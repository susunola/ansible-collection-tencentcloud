...
options:
  cluster_ids:
    ...
    elements: str
  filters:
    description: THPC API filter names mapped to lists of values.
    type: dict
    default:
      {}
  page_size:
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.thpc_cluster
    description: Manage Tencent Cloud THPC clusters.
...
RETURN = r'''
clusters:
  description: Matching THPC clusters.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        ...
        module.fail_json(msg="The tencentcloud-sdk-python-thpc package is required.")

    client = thpc_client.ThpcClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "thpc.tencentcloudapi.com"),
    )
    paginator = Paginator(

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.mqtt_user
    description: Manage Tencent Cloud MQTT users.
...
RETURN = r'''
users:
  description: Matching MQTT users.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda offset, limit: build_request(
            ...
            offset,
            limit),
        lambda request: sdk_call(module, client.DescribeUserList, request),

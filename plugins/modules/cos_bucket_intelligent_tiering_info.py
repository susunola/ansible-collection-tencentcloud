...
DOCUMENTATION = r'''
---
module: cos_bucket_intelligent_tiering_info
short_description: Gather Tencent Cloud COS intelligent-tiering configuration
version_added: "1.4.0"
description: Returns the effective normalized default intelligent-tiering rule of a COS bucket.
options:
...
'''
EXAMPLES = r'''
- susunola.tencentcloud.cos_bucket_intelligent_tiering_info:
    region: ap-guangzhou
    name: archive
'''
RETURN = r'''

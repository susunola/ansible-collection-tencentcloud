...
RETURN = r'''
rabbit_mq_users:
  description: Matching TDMQ rabbit mq users.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeRabbitMQUser, request),
        lambda response: response.RabbitMQUserList,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    rabbit_mq_users = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, rabbit_mq_users=rabbit_mq_users,

...
RETURN = r'''
rabbit_mq_bindings:
  description: Matching TDMQ rabbit mq bindings.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeRabbitMQBindings, request),
        lambda response: response.BindingInfoList,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    rabbit_mq_bindings = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, rabbit_mq_bindings=rabbit_mq_bindings,

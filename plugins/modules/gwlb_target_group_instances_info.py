...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.gwlb_target_group_instances
    description: Reconcile Tencent Cloud GWLB target group instances.
...
target_group_instances:
  description: Matching GWLB target group instances.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeTargetGroupInstances, request),
        lambda response: response.TargetGroupInstanceSet,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    target_group_instances = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, target_group_instances=target_group_instances,

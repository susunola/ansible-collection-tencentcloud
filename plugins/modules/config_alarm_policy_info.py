...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.config_alarm_policy
    description: Manage Tencent Cloud Config alarm policies.
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.ListAlarmPolicy, request),
        lambda response: response.AlarmPolicyList,

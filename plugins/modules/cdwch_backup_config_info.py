...
options:
  instance_id:
    description: Sets the C(InstanceId) field of V(DescribeBackUpSchedule); omit it to leave that field unset.
    type: str
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cdwch_backup_config
    description: Manage Tencent Cloud CDW ClickHouse backup configuration.

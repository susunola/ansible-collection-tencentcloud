...
RETURN = r'''
rocket_mq_topics:
  description: Matching TDMQ rocket mq topics.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeRocketMQTopics, request),
        lambda response: response.Topics,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    rocket_mq_topics = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, rocket_mq_topics=rocket_mq_topics,

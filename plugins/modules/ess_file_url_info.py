...
RETURN = r'''
file_urls:
  description: Matching ESS file urls.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        from tencentcloud.ess.v20201111 import models, ess_client
    except ImportError:
        module.fail_json(msg="The tencentcloud-sdk-python-ess package is required.")

    client = ess_client.EssClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "ess.tencentcloudapi.com"),
    )
    paginator = Paginator(
    ...
    file_urls = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, file_urls=file_urls, total_count=total_count)

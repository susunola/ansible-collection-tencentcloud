...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dcdb_backup_config
    description: Manage Tencent Cloud DCDB automatic backup configuration.
...
RETURN = r'''
backup_configs:
  description: Matching DCDB backup configs.
  returned: always
  type: list
  elements: dict
total_count:
...
def build_request(models, instance_id, offset, limit):
    # DescribeBackupConfigs returns the full list in one call and is not
...
def run_module():
    ...
    items = response.BackupConfigSet or []

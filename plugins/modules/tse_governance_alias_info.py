...
RETURN = r'''
governance_aliases:
  description: Matching TSE governance aliases.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeGovernanceAliases, request),
        lambda response: response.Content,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    governance_aliases = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, governance_aliases=governance_aliases,

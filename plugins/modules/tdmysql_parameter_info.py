...
def run_module():
    module = TencentCloudModule(argument_spec={"instance_id": {"required": True}, "names": {"type": "list", "elements": "str"}}, supports_check_mode=True); p = module.params
    ...
    try:
        ...
        if p.get("names") is not None:
            ...
            if missing: module.fail_json(msg="unknown TDSQL MySQL parameter names", unknown_parameters=missing)

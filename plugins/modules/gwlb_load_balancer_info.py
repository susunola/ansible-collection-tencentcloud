...
def build_request(models, search_key, gateway_load_balancer_ids, filters, offset, limit):
...
def run_module():
    ...
    module.exit_json(changed=False, gateway_load_balancers=gateway_load_balancers,

...
options:
  ...
  config_id:
    description:
      - CLS configuration ID.
    type: str
    required: true
  group_id:
    description:
      - CLS machine group ID.
    type: str
    required: true
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cls_config_machine_group_binding_info
    description: Gather information about Tencent Cloud CLS machine group config bindings.

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.goosefs_file_system
    description: Manage Tencent Cloud GooseFS file systems.
...
RETURN = r'''
file_systems:
  description: Matching GOOSEFS file systems.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeFileSystems, request),
        lambda response: response.FSAttributeList,

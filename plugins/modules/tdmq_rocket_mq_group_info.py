...
RETURN = r'''
rocket_mq_groups:
  description: Matching TDMQ rocket mq groups.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeRocketMQGroups, request),
        lambda response: response.Groups,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    rocket_mq_groups = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, rocket_mq_groups=rocket_mq_groups,

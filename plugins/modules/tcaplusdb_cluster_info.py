...
options:
  cluster_ids:
    ...
    elements: str
  filters:
    description: TCAPLUSDB API filter names mapped to lists of values.
    type: dict
    default: {}
  page_size:
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tcaplusdb_cluster
    description: Manage Tencent Cloud TcaplusDB clusters.
...
RETURN = r'''
clusters:
  description: Matching TCAPLUSDB clusters.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        ...
        module.fail_json(msg="The tencentcloud-sdk-python-tcaplusdb package is required.")

    client = tcaplusdb_client.TcaplusdbClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "tcaplusdb.tencentcloudapi.com"),
    )
    paginator = Paginator(

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tsf_microservice
    description: Manage a Tencent Cloud TSF microservice.
...
RETURN = r'''
microservices:
  description: Matching microservices.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeMicroservices, request),
    ...
    microservices = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, microservices=microservices,

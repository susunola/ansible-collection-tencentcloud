...
def read(module, client, models, p):
    ...
    for page in range(1, p["max_pages"] + 1):
        response = module.sdk_call(client.ListModelVersions, build_request(models, p, page)); items = response.Items or []
...
def run_module():
    ...
    spec = {
        "model_uid": {"required": True}, "start_time": {"type": "int"}, "end_time": {"type": "int"},
        "filters": {"type": "dict", "default": {}}, "sort_fields": {"type": "list", "elements": "dict", "options": sort},

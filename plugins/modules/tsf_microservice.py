...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tsf_microservice_info
    description: Gather information about Tencent Cloud TSF microservices.
...
RETURN = r"""microservice:
  ...
  sample:
    ...
    NamespaceId: namespace-8b0a1c2d
    MicroserviceName: orders
    MicroserviceDesc: Renamed order service
"""

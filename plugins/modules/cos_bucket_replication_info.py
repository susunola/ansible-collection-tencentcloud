...
DOCUMENTATION = r'''
---
module: cos_bucket_replication_info
short_description: Gather Tencent Cloud COS bucket replication
version_added: "1.4.0"
description: Returns the effective normalized replication configuration of a COS bucket.
options:
  name:
    description:
...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cos_bucket_replication
    description: Manage Tencent Cloud COS bucket replication.
author: Tencent Cloud Ansible Collection Contributors (@susunola)
'''
EXAMPLES = r'''
- susunola.tencentcloud.cos_bucket_replication_info:
    region: ap-guangzhou
    name: source-data
'''
RETURN = r'''
...
from ansible_collections.susunola.tencentcloud.plugins.module_utils.cos_bucket_read import get_replication

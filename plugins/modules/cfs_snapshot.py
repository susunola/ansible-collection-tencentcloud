...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cfs_snapshot_info
    description: Gather information about Tencent Cloud CFS snapshots.
...
RETURN = r"""snapshot:
  description:
    - CFS snapshot metadata.
  returned: always
  type: dict
  sample:
    # shape captured from this module's unit tests -- scripts/add_return_samples.py
    SnapshotId: snap-cfs-new-001

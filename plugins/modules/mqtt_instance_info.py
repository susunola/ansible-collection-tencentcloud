...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.mqtt_instance
    description: Manage Tencent Cloud MQTT instances.
...
RETURN = r'''
instances:
  description: Matching MQTT instances.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeInstanceList, request),

...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.dlc_job_spec
    description: Manage reusable Tencent Cloud DLC job specifications.
...
RETURN = r'''
job_specs:
  description: Matching DLC job specs.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.ListJobSpecs, request),
        lambda response: response.Items,
        lambda response: response.Total,
    )
    item_set, total_count = paginator.fetch_all()
    job_specs = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, job_specs=job_specs,

...
RETURN = r'''
spark_app_jobs:
  description: Matching DLC spark app jobs.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeSparkAppJobs, request),
        lambda response: response.SparkAppJobs,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    spark_app_jobs = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, spark_app_jobs=spark_app_jobs,

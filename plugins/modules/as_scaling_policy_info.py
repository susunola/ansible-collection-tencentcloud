...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.as_scaling_policy
    description: Manage Tencent Cloud Auto Scaling policies.
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda offset, limit: build_request(
            ...
            offset,
            limit),
        lambda request: sdk_call(module, client.DescribeScalingPolicies, request),
        lambda response: response.ScalingPolicySet,
        lambda response: response.TotalCount,
    )
    item_set, total_count = paginator.fetch_all()
    scaling_policies = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, scaling_policies=scaling_policies,

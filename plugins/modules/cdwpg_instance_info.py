...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.cdwpg_instance
    description: Manage Tencent Cloud CDW PostgreSQL instances.
...
RETURN = r'''
instances:
  description: Matching CDWPG instances.
  returned: always
  type: list
  elements: dict
total_count:
...
def build_request(models, search_instance_id, search_instance_name, offset, limit):

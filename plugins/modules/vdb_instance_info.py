...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.vdb_instance
    description: Manage Tencent Cloud VectorDB instances.
...
RETURN = r'''
instances:
  description: Matching VDB instances.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        ...
        module.fail_json(msg="The tencentcloud-sdk-python-vdb package is required.")

    client = vdb_client.VdbClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "vdb.tencentcloudapi.com"),
    )
    paginator = Paginator(

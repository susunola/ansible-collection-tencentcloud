...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.redis_backup_config_info
    description: Gather information about a Tencent Cloud Redis backup configuration.

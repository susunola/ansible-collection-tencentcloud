...
RETURN = r'''
answers:
  description: Matching LCIC answers.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        from tencentcloud.lcic.v20220817 import models, lcic_client
    except ImportError:
        module.fail_json(msg="The tencentcloud-sdk-python-lcic package is required.")

    client = lcic_client.LcicClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "lcic.tencentcloudapi.com"),
    )
    paginator = Paginator(
    ...
    answers = [serialize_sdk_object(item) for item in item_set]
    module.exit_json(changed=False, answers=answers, total_count=total_count)

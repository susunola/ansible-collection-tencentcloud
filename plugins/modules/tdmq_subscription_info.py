...
attributes:
  ...
  idempotent:
    ...
    support: full
seealso:
  - module: susunola.tencentcloud.tdmq_subscription
    description: Manage Tencent Cloud TDMQ Pulsar subscriptions.
...
RETURN = r'''
subscriptions:
  description: Matching TDMQ subscriptions.
  returned: always
  type: list
  elements: dict
  sample:
...
def run_module():
    ...
    paginator = Paginator(
        ...
        lambda request: sdk_call(module, client.DescribeSubscriptions, request),
        lambda response: response.SubscriptionSets,

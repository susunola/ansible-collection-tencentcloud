...
RETURN = r'''
resources:
  description: Matching ANICLOUD resources.
  returned: always
  type: list
  elements: dict
total_count:
...
def run_module():
    ...
    try:
        from tencentcloud.anicloud.v20220923 import models, anicloud_client
    except ImportError:
        module.fail_json(msg="The tencentcloud-sdk-python-anicloud package is required.")

    client = anicloud_client.AnicloudClient(
        create_credential(module), module.params["region"],
        create_client_profile(module, "anicloud.tencentcloudapi.com"),
    )
    paginator = Paginator(
        module.params["page_size"],
        lambda offset, limit: build_request(models, offset, limit),
        lambda request: sdk_call(module, client.QueryResource, request),

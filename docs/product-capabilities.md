...
| `dlc` | solution | 8 | 1 | `tc_dlc_access_governance` | `dlc_data_engine`, `dlc_database`, `dlc_user`, `dlc_user_policy`, `dlc_user_vpc_connection`, `dlc_work_group`, `dlc_work_group_membership`, `dlc_work_group_policy` |

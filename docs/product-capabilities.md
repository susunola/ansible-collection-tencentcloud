...
| `tse` | solution | 11 | 1 | `tc_tse_api_gateway`, `tc_tse_governance_platform` | `tse_cloud_native_gateway`, `tse_config_file`, `tse_config_file_group`, `tse_gateway_consumer`, `tse_gateway_public_network`, `tse_gateway_rate_limit`, `tse_gateway_route`, `tse_gateway_service`, +3 more |

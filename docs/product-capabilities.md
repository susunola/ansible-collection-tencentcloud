...
| `dlc` | solution | 12 | 1 | `tc_dlc_access_governance` | `dlc_data_engine`, `dlc_data_mask_strategy`, `dlc_database`, `dlc_engine_resource_group`, `dlc_lab`, `dlc_spark_job`, `dlc_user`, `dlc_user_policy`, +4 more |

...
| `dlc` | solution | 11 | 1 | `tc_dlc_access_governance` | `dlc_data_engine`, `dlc_data_mask_strategy`, `dlc_database`, `dlc_engine_resource_group`, `dlc_spark_job`, `dlc_user`, `dlc_user_policy`, `dlc_user_vpc_connection`, +3 more |

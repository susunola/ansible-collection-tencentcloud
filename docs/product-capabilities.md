...
| `tsf` | resource-family | 8 | 1 | — | `tsf_application`, `tsf_cluster`, `tsf_container_deployment_group`, `tsf_lane`, `tsf_lane_rule`, `tsf_microservice`, `tsf_namespace`, `tsf_vm_deployment_group` |

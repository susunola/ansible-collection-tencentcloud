...
| `tione` | resource-family | 7 | 7 | — | `tione_data_source`, `tione_dataset`, `tione_model_service`, `tione_model_service_state`, `tione_notebook`, `tione_training_model_version`, `tione_training_task` |

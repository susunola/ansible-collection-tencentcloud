...
| `dlc` | solution | 21 | 1 | `tc_dlc_access_governance` | `dlc_cluster_group`, `dlc_data_engine`, `dlc_data_mask_strategy`, `dlc_database`, `dlc_engine_resource_group`, `dlc_inference_model`, `dlc_job_spec`, `dlc_lab`, +13 more |

...
| `dlc` | solution | 6 | 1 | `tc_dlc_access_governance` | `dlc_data_engine`, `dlc_database`, `dlc_user_vpc_connection`, `dlc_work_group`, `dlc_work_group_membership`, `dlc_work_group_policy` |

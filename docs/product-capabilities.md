...
| `dlc` | solution | 18 | 1 | `tc_dlc_access_governance` | `dlc_cluster_group`, `dlc_data_engine`, `dlc_data_mask_strategy`, `dlc_database`, `dlc_engine_resource_group`, `dlc_job_spec`, `dlc_lab`, `dlc_partition_queue`, +10 more |

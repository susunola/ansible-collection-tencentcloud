...
| `dlc` | solution | 14 | 1 | `tc_dlc_access_governance` | `dlc_data_engine`, `dlc_data_mask_strategy`, `dlc_database`, `dlc_engine_resource_group`, `dlc_lab`, `dlc_partition_queue`, `dlc_resource_config`, `dlc_spark_job`, +6 more |

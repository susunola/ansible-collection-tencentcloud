...
| `tse` | solution | 15 | 1 | `tc_tse_api_gateway`, `tc_tse_governance_platform` | `tse_cloud_native_gateway`, `tse_config_file`, `tse_config_file_group`, `tse_gateway_consumer`, `tse_gateway_consumer_group`, `tse_gateway_cors`, `tse_gateway_ip_restriction`, `tse_gateway_public_network`, +7 more |

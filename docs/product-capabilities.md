...
| `lighthouse` | solution | 5 | 4 | `tc_lighthouse_stack` | `lighthouse_disk`, `lighthouse_firewall_rules`, `lighthouse_instance`, `lighthouse_key_pair`, `lighthouse_snapshot` |

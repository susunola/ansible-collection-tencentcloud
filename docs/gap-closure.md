...
| G1b | 单测广度（write 面） | 无专属单测 write 模块 222 → 111（440 中 25%，2026-09-08） | 覆盖率 81.64%（gate 80，2026-09-09） | 广度缺口缩小 | ✅ 里程碑达成，收口持续 |
...
**现状**：整体语句覆盖率 81.64%（2026-09-09 实测，10,297 tests / 30 skipped，
...
**验收**：整体实测覆盖率 ≥ 80% 且 gate 抬至 80（✅ 2026-09-08 达成 81.44%，09-09 随 P0-05 续升至 81.64%）；
write 面无专属单测模块持续收口。
...
_本计划由 docs/capability-map.html / docs/panorama.html INDUSTRY BENCHMARK 区块派生 · 2026-09-02 初版 · 2026-09-08 随 P0-12 刷新至 781 模块 / 204 产品 / gate 80 口径 · 2026-09-09 随 P0-05 刷新覆盖率至 81.64% · 数据均为源码实测 + Galaxy 产物实拉_

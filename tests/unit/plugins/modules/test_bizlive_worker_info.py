...
from ansible_collections.susunola.tencentcloud.plugins.modules import bizlive_worker_info
...
class FakeModels:
    DescribeWorkersRequest = FakeRequest
...
def test_run_module_returns_full_list(monkeypatch):
    ...
    assert [item["Marker"] for item in payload["workers"]] == ["a", "b"]

from ansible_collections.susunola.tencentcloud.plugins.modules.tdmysql_maintenance_window import (
    expected_range,
    modify_request as maintenance_request,
    normalize_start,
)
...
class Models:
    ModifyMaintenanceWindowRequest = ModifyInstanceSSLStatusRequest = Object

...
# ---------------------------------------------------------------------------
# legacy helper regression tests (folded from test_tione_training_model_version.py)
# ---------------------------------------------------------------------------
...
class LegacyModels(object):
    CreateTrainingModelRequest = DeleteTrainingModelVersionRequest = CosPathInfo = ImageInfo = LegacyObject
...
def legacy_params():
    return {
        ...
        "training_job_id": "t1",
        "training_job_version": "i1",
        "training_model_cos_path": None,
        "model_output_path": {"Bucket": "out"},
        "training_model_source": "JOB",
        "algorithm_framework": "PYTORCH",
        "reasoning_environment": None,
        "reasoning_environment_id": "img1",
        "reasoning_image_info": None,
        "training_model_index": None,
        "model_move_mode": "COPY",
        "training_preference": None,
        "model_version_type": "NORMAL",
        "model_format": "PYTORCH",
        "auto_clean": "false",
        "max_reserved_models": 12,
        "model_clean_period": 60,
        "is_qat": False,
        "delete_cos": True,
    }
...
def test_delete_uses_only_stable_version_id_and_cos_choice():
    request = mod.delete_request(LegacyModels, legacy_params())
...
def test_conflicts_uses_readable_dto_names():
    ...
    current = {
        ...
        "TrainingModelId": "m1",
        "TrainingJobId": "t1",
        "TrainingJobVersion": "i1",
        "ModelOutputPath": {"Bucket": "out"},
        "TrainingModelSource": "JOB",
        "AlgorithmFramework": "PYTORCH",
        "ReasoningEnvironmentSource": "SYSTEM",
        "ReasoningEnvironmentId": "img1",
        "VersionType": "NORMAL",
        "TrainingModelFormat": "PYTORCH",
        "AutoClean": "false",
        "MaxReservedModels": 12,
        "ModelCleanPeriod": 60,
        "IsQAT": False,
    }
    assert mod.conflicts(p, current) == {}

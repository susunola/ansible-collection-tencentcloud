...
def params():
    return {
        ...
        "storage_data_path": {"Bucket": "b"},
        "storage_label_path": None,
        "dataset_tags": [{"TagKey": "env", "TagValue": "prod"}],
        "annotation_status": None,
        "annotation_type": None,
        "annotation_format": None,
        "schema_infos": None,
        "is_schema_existed": None,
        "content_type": "TYPE_TEXT_LINE",
        "dataset_scene": "LLM",
        "scene_tags": ["z", "a"],
        "cfs_config": None,
...
class Response:
    def __init__(self, values, total):
        self.DatasetGroups, self.TotalCount = [Item(x) for x in values], total
...
def test_conflict_normalizes_unordered_tags_and_scene_tags():
    ...
    current = {
        ...
        "StorageDataPath": {"Bucket": "b"},
        "DatasetTags": [{"TagValue": "prod", "TagKey": "env"}],

...
def test_request_builders():
    models = FakeModels()
    params = {"name": "api-client", "vpc_id": "vpc-1", "subnet_id": "subnet-1", "endpoint_service_id": "vpcsvc-1", "endpoint_vip": None, "security_group_ids": ["sg-1"], "ip_address_type": "IPv4", "tags": {"env": "prod"}}

...
from ansible_collections.susunola.tencentcloud.plugins.modules import cloudaudit_audit_info
...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(cloudaudit_audit_info, "AnsibleModule", lambda **kwargs: fake)
    monkeypatch.setattr(cloudaudit_audit_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cloudaudit_audit_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        cloudaudit_audit_info.run_module()
    return fake
...
def test_run_module_returns_full_list(monkeypatch):
    ...
    assert [item["Marker"] for item in payload["audits"]] == ["a", "b"]
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(cloudaudit_audit_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cloudaudit_audit_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(cloudaudit_audit_info, "sdk_call", failing_sdk_call)

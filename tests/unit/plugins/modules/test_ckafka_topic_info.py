...
from ansible_collections.susunola.tencentcloud.plugins.modules import ckafka_topic_info
...
def test_build_request_sets_pagination():
    request = ckafka_topic_info.build_request(FakeModels, "sample", 200, 100)
...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(ckafka_topic_info, "AnsibleModule", lambda **kwargs: fake)
    monkeypatch.setattr(ckafka_topic_info, "create_credential", lambda module: object())
    monkeypatch.setattr(ckafka_topic_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        ckafka_topic_info.run_module()
    return fake
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(ckafka_topic_info, "create_credential", lambda module: object())
    monkeypatch.setattr(ckafka_topic_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(ckafka_topic_info, "sdk_call", failing_sdk_call)

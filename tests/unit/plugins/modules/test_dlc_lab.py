from ansible_collections.susunola.tencentcloud.plugins.modules.dlc_lab import (
    delete_request,
    desired,
    drift,
    list_request,
...
def params():
    return {
        ...
        "enable_token": True,
        "example_id": None,
        "code_archive_url": None,
        "tags": [{"key": "team", "value": "data"}],
        "persistent_work_dir": None,
        "resource_config": '{ "worker": 2 }',
        "catalog": None,

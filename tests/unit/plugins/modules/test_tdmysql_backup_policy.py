...
class Object: pass
class Models: ModifyDBSBackupPolicyRequest = Object; BackupPolicyModelInput = Policy
...
def test_modify_request_derives_snapshot_storage_and_integer_flags():
    p = {"instance_id": "db1"}; target = {"BackupStartTime": "00:00", "BackupEndTime": "04:00", "BackupMethod": "snapshot", "EnableFull": True, "EnableLog": False, "FullRetentionPeriod": 7, "LogRetentionPeriod": 7, "PeriodTime": "0,1"}

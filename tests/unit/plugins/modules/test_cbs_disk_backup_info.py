...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(cbs_disk_backup_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cbs_disk_backup_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        cbs_disk_backup_info.run_module()
    return fake
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(cbs_disk_backup_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cbs_disk_backup_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(cbs_disk_backup_info, "sdk_call", failing_sdk_call)

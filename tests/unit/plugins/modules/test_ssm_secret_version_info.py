...
"""Skeleton unit tests for the ssm_secret_version_info write module (roadmap #57 lever 1).

Generated by scripts/generate_module_test_skeleton.py from a static read of
``plugins/modules/ssm_secret_version_info.py``. Assertions that encode the resource's drift rules

...
def test_build_request_sets_pagination():
    request = cdwpg_instance_info.build_request(FakeModels, "sample", "sample", 200, 100)
...
def test_run_module_paginates_until_total_count(monkeypatch):
    ...
    fake = _run(monkeypatch, client, region="ap-guangzhou",
                search_instance_id="sample", search_instance_name="sample", page_size=2)
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(cdwpg_instance_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cdwpg_instance_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(cdwpg_instance_info, "sdk_call", failing_sdk_call)

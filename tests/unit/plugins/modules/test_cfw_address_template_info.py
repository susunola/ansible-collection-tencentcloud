...
def test_build_request_sets_pagination():
    request = cfw_address_template_info.build_request(FakeModels, "sample", "sample", "sample", "sample", "sample", "sample", 200, 100)
...
def test_run_module_paginates_until_total_count(monkeypatch):
    ...
    fake = _run(monkeypatch, client, region="ap-guangzhou",
                by="sample", order="sample", search_value="sample", uuid="sample", template_type="sample", template_id="sample", page_size=2)

...
from ansible_collections.susunola.tencentcloud.plugins.modules import teo_function_info
...
class FakeModels:
    Filter = FakeFilter
    DescribeFunctionsRequest = FakeRequest
...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(teo_function_info, "AnsibleModule", lambda **kwargs: fake)
    monkeypatch.setattr(teo_function_info, "create_credential", lambda module: object())
    monkeypatch.setattr(teo_function_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        teo_function_info.run_module()
    return fake
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(teo_function_info, "create_credential", lambda module: object())
    monkeypatch.setattr(teo_function_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(teo_function_info, "sdk_call", failing_sdk_call)

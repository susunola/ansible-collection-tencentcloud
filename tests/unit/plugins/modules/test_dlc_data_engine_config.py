from ansible_collections.susunola.tencentcloud.plugins.modules.dlc_data_engine_config import (
    _pairs, _template, describe_request, desired, engine_request, normalize, update_request,
)
...
def test_configuration_normalization_is_order_independent():
    value = normalize({"DataEngineId": "engine-1", "DataEngineConfigPairs": [
        {"ConfigItem": "z", "ConfigValue": "2"}, {"ConfigItem": "a", "ConfigValue": "1"}],
        "SessionResourceTemplate": {"ExecutorNums": 2, "RunningTimeParameters": [
            {"ConfigItem": "b", "ConfigValue": "2"}, {"ConfigItem": "a", "ConfigValue": "1"}]}})
...
def test_update_serializes_complete_configuration():
    target = {"DataEngineId": "engine-1", "DataEngineConfigPairs": _pairs([{"key": "b", "value": "2"}, {"key": "a", "value": "1"}]),

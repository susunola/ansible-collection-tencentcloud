...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(cdwch_backup_config_info, "AnsibleModule", lambda **kwargs: fake)
    monkeypatch.setattr(cdwch_backup_config_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cdwch_backup_config_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        cdwch_backup_config_info.run_module()
    return fake
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(cdwch_backup_config_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cdwch_backup_config_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(cdwch_backup_config_info, "sdk_call", failing_sdk_call)

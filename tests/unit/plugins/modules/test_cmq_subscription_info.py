...
from ansible_collections.susunola.tencentcloud.plugins.modules import cmq_subscription_info
...
class FakeModels:
    DescribeCmqSubscriptionDetailRequest = FakeRequest
...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(cmq_subscription_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cmq_subscription_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        cmq_subscription_info.run_module()
    return fake
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(cmq_subscription_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cmq_subscription_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(cmq_subscription_info, "sdk_call", failing_sdk_call)

...
class FakeModels:
    Filters = FakeFilter
    DescribeNodeDataDisksRequest = FakeRequest
...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(emr_node_data_disk_info, "AnsibleModule", lambda **kwargs: fake)
    monkeypatch.setattr(emr_node_data_disk_info, "create_credential", lambda module: object())
    monkeypatch.setattr(emr_node_data_disk_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        emr_node_data_disk_info.run_module()
    return fake
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(emr_node_data_disk_info, "create_credential", lambda module: object())
    monkeypatch.setattr(emr_node_data_disk_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(emr_node_data_disk_info, "sdk_call", failing_sdk_call)

...
from ansible_collections.susunola.tencentcloud.plugins.modules import cdwpg_account_info
...
def test_build_request_sets_pagination():
    request = cdwpg_account_info.build_request(FakeModels, "sample", 200, 100)
...
def _inject_sdk(monkeypatch, client):
    ...
    monkeypatch.setitem(sys.modules, "tencentcloud.cdwpg",
                        types.ModuleType("tencentcloud.cdwpg"))
...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(cdwpg_account_info, "AnsibleModule", lambda **kwargs: fake)
    monkeypatch.setattr(cdwpg_account_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cdwpg_account_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        cdwpg_account_info.run_module()
    return fake
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(cdwpg_account_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cdwpg_account_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(cdwpg_account_info, "sdk_call", failing_sdk_call)

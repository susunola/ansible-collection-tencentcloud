...
from ansible_collections.susunola.tencentcloud.plugins.modules.tse_gateway_service import health_update_request, targets_match, targets_request, contains, desired, write_request
...
def test_gateway_upstream_requests_map_targets_and_health_checks():
    p={"gateway_id":"g1"}; targets=[{"Host":"10.0.0.1","Port":80,"Weight":100}]; health={"EnableActiveHealthCheck":True}

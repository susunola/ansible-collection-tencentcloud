...
class FakeModels:
    DescribeVcubeResourcesListRequest = FakeRequest
...
def _inject_sdk(monkeypatch, client):
    service = types.ModuleType("tencentcloud.vcube.v20220410")
    service.models = FakeModels
    service.vcube_client = types.SimpleNamespace(VcubeClient=lambda *args: client)
    monkeypatch.setitem(sys.modules, "tencentcloud", types.ModuleType("tencentcloud"))
    monkeypatch.setitem(sys.modules, "tencentcloud.vcube",
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(vcube_resource_info, "create_credential", lambda module: object())
    monkeypatch.setattr(vcube_resource_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(vcube_resource_info, "sdk_call", failing_sdk_call)

...
def params(): return {"model_uid": "model-1", "version": "v2", "description": "release", "storage_uri": "cos://bucket/v2", "use_custom_storage": True, "storage_type": "COS", "goosefs_config": None}


def test_immutable_version_conflict_is_precise():
    p = params(); current = {"Version": "v2", "Description": "old", "StorageUri": "cos://bucket/v2", "UseCustomStorage": True}
...
def test_create_and_list_requests_use_parent_and_exact_version():
    p = params(); create = create_request(Models, p); listing = list_request(Models, p, 4)

...
from ansible_collections.susunola.tencentcloud.plugins.modules import gme_voice_print_info
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(gme_voice_print_info, "create_credential", lambda module: object())
    monkeypatch.setattr(gme_voice_print_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(gme_voice_print_info, "sdk_call", failing_sdk_call)

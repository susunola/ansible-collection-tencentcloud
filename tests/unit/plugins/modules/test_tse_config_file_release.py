...
def test_config_release_requests_map_publish_rollback_and_delete():
    p={"instance_id":"ins1","namespace":"production","group":"application","name":"orders.yaml","release_name":"stable","strict_enable":True,"content":"port: 8080","format":"YAML","comment":None,"release_description":"deploy","supported_client":None,"persistent":None,"beta_labels":None,"release_type":None,"rollback_version":"2"}
    target=desired(p)

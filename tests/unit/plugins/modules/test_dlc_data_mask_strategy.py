from ansible_collections.susunola.tencentcloud.plugins.modules.dlc_data_mask_strategy import create_request, delete_request, describe_request, normalize, normalize_groups, normalize_users, update_request
...
def target(): return {"StrategyId": "mask-1", "StrategyName": "phone", "StrategyType": "MASK_SHOW_LAST_4", "StrategyDesc": "phone mask", "Groups": [{"WorkGroupId": 2, "StrategyType": "MASK_HASH"}], "Users": ["10001", "10002"]}
...
def test_mutation_requests_serialize_normalized_users():
    created = create_request(Models, target()); updated = update_request(Models, target())

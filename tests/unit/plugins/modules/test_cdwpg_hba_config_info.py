...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(cdwpg_hba_config_info, "AnsibleModule", lambda **kwargs: fake)
    monkeypatch.setattr(cdwpg_hba_config_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cdwpg_hba_config_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        cdwpg_hba_config_info.run_module()
    return fake
...
def test_run_module_returns_full_list(monkeypatch):
    ...
    assert [item["Marker"] for item in payload["user_hba_configs"]] == ["a", "b"]
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(cdwpg_hba_config_info, "create_credential", lambda module: object())
    monkeypatch.setattr(cdwpg_hba_config_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(cdwpg_hba_config_info, "sdk_call", failing_sdk_call)

from ansible_collections.susunola.tencentcloud.plugins.modules.dlc_engine_resource_group import (
    base_request, capacity_request, config_delta, config_request, config_update_request, create_request, delete_request, describe_request, drift, network_request,
)
...
def test_create_maps_boolean_flags_capacity_and_sorted_networks():
    value = params(); value["static_config"] = {"spark.sql.shuffle.partitions": 200}; value["dynamic_config"] = {}
...
def test_config_query_and_exact_update_operations():
    ...
    delta = config_delta(changes); request = config_update_request(Models, "spark-etl", delta, True)

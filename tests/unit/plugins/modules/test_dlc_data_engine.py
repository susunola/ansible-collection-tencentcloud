...
def params():
    return {
        ...
        "auto_resume": True,
        "auto_suspend": None,
        "auto_suspend_time": None,
        "max_concurrency": 5,
        "tolerable_queue_time": None,
        "description": "production",
        "cidr_block": None,
        "engine_network_id": "network-1",
        "engine_exec_type": "SQL",
        "resource_type": "Standard_CU",
        "engine_generation": "SuperSQL",
        "image_version_name": None,
    }
...
def test_update_only_maps_mutable_values():
    ...
    value.update(
        {
            "crontab_resume_suspend": 1,
            "crontab_resume_suspend_strategy": {"ResumeTime": "08:00"},
            "elastic_switch": True,
            "elastic_limit": 32,
            "schedule_elasticity_conf": {"Enabled": True},
        }
    )

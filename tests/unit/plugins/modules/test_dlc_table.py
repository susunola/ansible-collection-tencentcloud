import base64
from ansible_collections.susunola.tencentcloud.plugins.modules.dlc_table import (
    comment_drift,
    comment_request,
    delete_request,
    generate_request,
...
def params():
    return {
        ...
        "data_format": "Parquet",
        "location": "cosn://bucket/sales",
        "primary_keys": ["id"],
        "columns": [{"name": "id", "type": "bigint", "nullable": False}],
        "partitions": [],
        "data_engine_name": "engine",
...
def test_generate_and_submit_requests_preserve_schema_and_encode_sql():
    p = params()
    generated = generate_request(Models, p)
    submitted = task_request(Models, p, "CREATE TABLE sales")
    ...
    current = normalize(
        {
            ...
            "Columns": [{"Name": "id", "Type": "BIGINT", "Nullable": "false", "Position": 0}],
            "Partitions": [],
            "Location": "cosn://bucket/sales",

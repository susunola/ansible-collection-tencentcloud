...
"""Skeleton unit tests for the tdmysql_database_object_info write module (roadmap #57 lever 1).

Generated by scripts/generate_module_test_skeleton.py from a static read of
``plugins/modules/tdmysql_database_object_info.py``. Assertions that encode the resource's drift rules
...
class FakeTdmysqlClient(object):
    ...
    def DescribeDatabaseObjects(self, request):
        ...
        self._record('DescribeDatabaseObjects', request)

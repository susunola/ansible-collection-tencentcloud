...
def test_request_builders():
    models = FakeModels()
    params = {"name": "backbone", "description": "prod", "qos_level": "AU", "instance_charge_type": "POSTPAID", "bandwidth_limit_type": None, "route_ecmp": True, "route_overlap": False, "traffic_marking_policy": True, "tags": {"env": "prod"}}

...
class Models(object): DescribeSREInstanceAccessAddressRequest=Value
class Response(object):
    RequestId="request-1"
    def _serialize(self,allow_none=False): return {"IntranetAddress":"10.0.0.8:8848","InternetAddress":"203.0.113.8:8848","RequestId":self.RequestId}

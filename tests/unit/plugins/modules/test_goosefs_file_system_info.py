...
def test_build_request_sets_pagination():
    request = goosefs_file_system_info.build_request(FakeModels, 200, 100)
...
def _run(monkeypatch, client, **params):
    ...
    monkeypatch.setattr(goosefs_file_system_info, "AnsibleModule", lambda **kwargs: fake)
    monkeypatch.setattr(goosefs_file_system_info, "create_credential", lambda module: object())
    monkeypatch.setattr(goosefs_file_system_info, "create_client_profile", lambda module, endpoint: object())
    with pytest.raises(ModuleExit):
        goosefs_file_system_info.run_module()
    return fake
...
def test_run_module_fails_cleanly_on_sdk_error(monkeypatch):
    ...
    monkeypatch.setattr(goosefs_file_system_info, "create_credential", lambda module: object())
    monkeypatch.setattr(goosefs_file_system_info, "create_client_profile", lambda module, endpoint: object())
    monkeypatch.setattr(goosefs_file_system_info, "sdk_call", failing_sdk_call)

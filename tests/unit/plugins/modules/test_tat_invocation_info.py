...
def params():
    return {"invocation_id": "inv-1", "command_id": None, "instance_kind": None, "include_output": False, "page_size": 100}


def test_exact_requests_are_bounded_and_hide_task_output():
    p = params()
    invocation = invocation_request(Models, p, 0)
    tasks = task_request(Models, p, 100)

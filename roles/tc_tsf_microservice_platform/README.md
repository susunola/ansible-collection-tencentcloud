  ...
  roles:
    - role: susunola.tencentcloud.tc_tsf_microservice_platform
      vars:
        ...
        tc_tsf_microservice_platform_repositories:
          - {name: production-packages, repository_type: private, bucket_name: tsf-packages-1250000000, bucket_region: ap-guangzhou}
        ...
        tc_tsf_microservice_platform_public_configs:
          - {name: shared-observability, version: v1, value: 'logging: {level: INFO}'}
        tc_tsf_microservice_platform_application_config_releases:
          - {config_id: config-xxxxxxxx, group_id: group-xxxxxxxx, release_description: Production settings}
        ...
        tc_tsf_microservice_platform_lanes:
          - name: orders-canary
            deployment_groups:

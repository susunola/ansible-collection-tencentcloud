...
def _sibling_script(name):
    """Import another script from this directory.

    The generator reuses ``normalize_module_docs`` and
    ``add_module_attributes`` so the formatting rules live in one place, but
    the unit tests load this file through ``importlib`` from a path that does
    not put ``scripts/`` on ``sys.path``.  Importing without that fails with
    ModuleNotFoundError only under test, so make the directory importable
    first.
    """
        ...
        'extra_params': [
            {
                ...
                'type': 'str',
                'required': True,
                'doc': 'ID of the CDB instance whose audit configuration is returned.',
            },
        ],
        'response_items': None,
        'response_total': None,
...
""",
    },
    {
        ...
        'filters': None,
        'extra_params': [
            {'name': 'instance_id', 'field': 'InstanceId', 'type': 'str', 'required': True, 'doc': 'ID of the CDB instance.'},
            {'name': 'user', 'field': 'User', 'type': 'str', 'required': True, 'doc': 'Account name whose privileges are returned.'},
            {'name': 'host', 'field': 'Host', 'type': 'str', 'required': True, 'doc': 'Account host, for example C(%) or C(10.0.0.%).'},
        ],
        'response_items': None,
        'response_total': None,
        ...
        'extra_params': [
            {
                ...
                'type': 'str',
                'required': True,
                'doc': 'ID of the MongoDB instance whose backup rules are returned.',
            },
        ],
        'response_items': None,
        'response_total': None,
        ...
        'extra_params': [
            {
                ...
                'type': 'str',
                'required': True,
                'doc': 'ID of the PostgreSQL instance whose backup plans are returned.',
            },
        ],
        ...
        'extra_params': [
            {
                ...
                'type': 'str',
                'required': True,
                'doc': 'ID of the Redis instance whose backup configuration is returned.',
            },
        ],
        'response_items': None,
        'response_total': None,
        ...
        'extra_params': [
            {
                ...
                'type': 'str',
                'required': True,
                'doc': 'ID of the CynosDB cluster whose backup configuration is returned.',
            },
        ],
        'response_items': None,
        'response_total': None,
        ...
        'extra_params': [
            {
                ...
                'type': 'str',
                'required': True,
                'doc': 'ID of the MariaDB instance whose backup configuration is returned.',
            },
        ],
        'response_items': None,
        'response_total': None,
        ...
        'extra_params': [
            {
                ...
                'type': 'str',
                'required': True,
                'doc': 'ID of the launch template whose versions are returned.',
            },
        ],
...
""",
    },
    {
        ...
        'ids': {
            ...
            'field': 'DisasterRecoverGroupIds',
            'doc': 'Placement group IDs to return. Mutually exclusive with O(filters).',
        },
        'filters': {'doc': 'CVM API filter names mapped to lists of values.'},
        'extra_params': [],
...
""",
    },
    {
        ...
        'filters': {'doc': 'VPC API filter names mapped to lists of values.'},
        'extra_params': [
            {'name': 'ccn_id', 'field': 'CcnId', 'type': 'str', 'required': True, 'doc': 'ID of the CCN instance whose attachments are returned.'},
        ],
        'response_items': 'InstanceSet',
        'response_total': 'TotalCount',
...
""",
    },
    {
        ...
        'filters': {'doc': 'APIGATEWAY API filter names mapped to lists of values.'},
        'extra_params': [
            {'name': 'service_id', 'field': 'ServiceId', 'type': 'str', 'required': True, 'doc': 'ID of the API Gateway service whose APIs are returned.'},
        ],
...
""",
    },
    {
        ...
        'filters': None,
        'extra_params': [
            {'name': 'group_id', 'field': 'GroupId', 'type': 'str', 'required': True, 'doc': 'ID of the CLS machine group whose bound configs are returned.'},
        ],
...
def _documentation(spec):
    ...
    # scripts/add_module_attributes.py would write, which is what the --check
    # modes on both scripts assert.
    build_block = _sibling_script("add_module_attributes").build_block
    lines += build_block("supports_check_mode=True", "%s_info.py" % spec["module"])
    # A generated _info module cross-references the write module that manages
    # the same resource; seealso() computes it from the catalogue so the two
    # cannot disagree about whether the counterpart exists.
    seealso = _sibling_script("add_module_seealso")
    lines += seealso.build_block(spec["module"], set(seealso.modules()))
    lines += [
        f"author: {AUTHOR}",
    ]
    return "\n".join(lines)
...
def render_module(spec):
    ...
    normalize_text = _sibling_script("normalize_module_docs").normalize_text

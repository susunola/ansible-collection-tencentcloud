...
CORE_MODULES = {
    ...
    "cls_topic",
    "cloudaudit_track",
    "cloudaudit_track_info",
    "cloudaudit_audit",
    "cloudaudit_audit_info",
    "ckafka_topic",
    "ckafka_instance",
    "ckafka_user",
    "ckafka_route",
    "ckafka_route_info",
    "ckafka_acl_rule",
    "ckafka_acl_rule_info",
    "ckafka_datahub_topic",
    "ckafka_datahub_topic_info",
    "ckafka_datahub_connection",
    "ckafka_datahub_connection_info",
    "ckafka_datahub_task",
    "ckafka_datahub_task_info",
    "ckafka_acl",
    "ckafka_acl_info",
    "clb_listener",
    "clb_listener_target",
    ...
    "cos_bucket",
    "cos_bucket_policy",
    "cos_bucket_policy_info",
    "cos_bucket_replication",
    "cos_bucket_replication_info",
    "cos_bucket_website",
    "cos_bucket_website_info",
    "cos_bucket_encryption",
    "cos_bucket_encryption_info",
    "cos_bucket_logging",
    "cos_bucket_logging_info",
    "cos_bucket_object_lock",
    "cos_bucket_object_lock_info",
    "cos_bucket_intelligent_tiering",
    "cos_bucket_intelligent_tiering_info",
    "cos_bucket_origin",
    "cos_bucket_origin_info",
    "cos_bucket_response_control",
    "cos_bucket_response_control_info",
    "cos_bucket_inventory",
    "cos_bucket_inventory_info",
    "cos_bucket_referer",
    "cos_bucket_referer_info",
    "cos_bucket_domain",
    "cos_bucket_domain_info",
    "cos_bucket_domain_certificate",
    "cos_bucket_domain_certificate_info",
    "cos_object",
    "cos_object_info",
    "cos_object_sync",
    "config_rule",
    ...
    "config_compliance_pack_info",
    "config_remediation",
    "config_alarm_policy",
    "config_alarm_policy_info",
    "config_aggregator",
    ...
    "dlc_user_policy",
    "dnspod_custom_line",
    "dnspod_custom_line_info",
    "dnspod_line_group",
    "dnspod_line_group_info",
    "dnspod_domain",
    "dnspod_domain_info",
    "dts_consumer_group",
    ...
    "cdwdoris_cooldown_policy_info",
    "cdwdoris_user_workload_group",
    "cdwdoris_user_workload_group_info",
    ...
    "chdfs_access_group",
    "chdfs_access_group_info",
    "chdfs_access_rules",
    "chdfs_access_rules_info",
    "chdfs_mount_access_groups",
    "chdfs_mount_access_groups_info",
    "key_pair",
    "kms_key",
    "kms_key_rotation",
    "lighthouse_instance",
    ...
    "tsf_application",
    "tsf_cluster",
    "tsf_application_config", "tsf_application_config_release", "tsf_container_deployment_group", "tsf_lane", "tsf_lane_rule", "tsf_public_config", "tsf_repository",
    "tsf_microservice",
    "tsf_namespace",
    ...
    "cdwch_instance_info",
    "cdwch_backup_config",
    "cdwch_backup_config_info",
    "cdwch_parameter",
    "cdwch_parameter_info",
